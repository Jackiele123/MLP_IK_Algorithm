...
model_checkpoint_path = 'model_epoch_03.h5'
...
# model = tf.keras.models.load_model('goodEpochs/model_epoch_02.h5', custom_objects={'euclidean_loss': euclidean_loss})
# # Example usage
...
# print("Predicted Joint Angles:", predicted_angles*180/np.pi)
